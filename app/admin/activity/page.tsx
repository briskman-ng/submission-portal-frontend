...
export default function ActivityLogPage() {
  ...
  const allActivity = useMemo(() => {
    return mockSubmissions.flatMap(submission =>
  ...
  }, [allActivity, searchQuery, actionFilter, userFilter, dateFilter, startDate, endDate]);
  ...
  const actionOptions = [
    'created', 'viewed', 'status_changed', 'forwarded', 
    'note_added', 'response_sent', 'priority_changed', 'assigned', 'downloaded'
  ];
  ...
  const hasActiveFilters = actionFilter || userFilter || dateFilter !== 'all' || searchQuery;
      ...
      <div className="p-6">
            ...
            {showFilters && (
              <div className="mt-4 pt-4 border-t border-stone-200">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {/* Action Filter */}
                  <div>
                    <label className="block text-sm font-medium text-stone-700 mb-1">Action Type</label>
                    <select
                      value={actionFilter}
                  ...
                  {/* User Filter */}
                  <div>
                    <label className="block text-sm font-medium text-stone-700 mb-1">Admin User</label>
                    <select
                      value={userFilter}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-stone-200 p-4">
            <p className="text-2xl font-bold text-stone-900">{filteredActivity.length}</p>
            <p className="text-xs text-stone-500">Total Activities</p>
          </div>
          <div className="bg-white rounded-xl border border-stone-200 p-4">
            <p className="text-2xl font-bold text-stone-900">
              {filteredActivity.filter(a => a.action === 'status_changed').length}
            </p>
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-4">
            <p className="text-2xl font-bold text-stone-900">
              {filteredActivity.filter(a => a.action === 'response_sent').length}
            </p>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-2 mt-1">
                              ...
                              <span className="text-xs text-stone-500 truncate max-w-xs">{activity.subject}</span>
                            </div>
                          </div>
                          <div className="text-right flex-shrink-0">
                            <p className="text-xs font-medium text-stone-700">{activity.userName}</p>
