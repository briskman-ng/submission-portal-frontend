...
export default function LandingPage() {
  const trustIndicators = [
    ...
    { icon: Clock, label: "24/7 Availability", sublabel: "Submit anytime" },
    {
      ...
      sublabel: "Tracking ID provided",
    },
    {
      icon: BarChart3,
      label: "Real-Time Status",
      sublabel: "Monitor progress",
    },
  ];
  ...
  const processSteps = [
    {
      step: "01",
      title: "Submit",
      desc: "Fill out the form and upload your documents through our secure portal.",
      icon: Send,
    },
    {
      step: "02",
      title: "Confirm",
      desc: "Receive instant confirmation with a unique tracking ID via email.",
      icon: CheckCircle,
    },
    {
      step: "03",
      title: "Process",
      desc: "Our team reviews and routes your submission to the appropriate department.",
      icon: Users,
    },
    {
      step: "04",
      title: "Resolve",
      desc: "Track progress in real-time and receive notifications on updates.",
      icon: Globe,
    },
  ];
      ...
      <section className="pt-20 relative overflow-hidden mesh-gradient pattern-overlay">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-1/2 space-y-5 opacity-0 animate-fade-in-up">
              ...
              <p className="text-base text-stone-600 max-w-md leading-relaxed">
                The official portal for all proposals, reports, requests and
                feedback to the Niger Delta Development Commission. Every
                submission is tracked, timestamped, and processed transparently.
              </p>
          ...
          <div className="flex justify-center mt-8">
            <a
              href="#process"
              className="flex flex-col items-center gap-2 text-stone-400 hover:text-emerald-600 transition-colors"
            >
                ...
                <div className="bg-stone-50 rounded-2xl p-6 hover:bg-emerald-50 transition-colors border border-stone-100 hover:border-emerald-200 h-full">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h3 className="font-display text-lg font-semibold text-emerald-900 mt-1">
                        {item.title}
                      </h3>
